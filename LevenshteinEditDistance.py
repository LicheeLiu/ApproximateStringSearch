...
def LevenshteinEditDistance(misspellWord, dictWord):
...
def neighbourhood(misspell, dictionary):
	...
	for misspellWord in misspell:
		...
		for dictWord in dictionary:
			editNumber = LevenshteinEditDistance(misspellWord, dictWord)
...
def evaluate(correctAnswer, correctedWords, nonAttempted):
	...
	text_file = open("neighbourhoodM.txt", "w")
...
def writeInCsv(correctedWords, correctAnswer):
	...
	with open("neighbourhoodMethod.csv", "w", newline = '') as f:
		writer = csv.writer(f)
